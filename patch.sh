...
# Patch toolbox for ArchInit — fix & patch utilities
...
render_menu() {
    ...
    echo ""
    echo "========================================================================================================================="
    echo "                     ArchInit — 修补工具 / Patch Tools"
    echo "========================================================================================================================="
    echo ""
...
execute_step() {
    ...
    local ret_val=0
    local SCRIPT_DIR user_dirs_conf user_dirs_bak
    local EN_DESKTOP EN_DOWNLOAD EN_TEMPLATES EN_PUBLIC EN_DOCUMENTS EN_MUSIC EN_PICTURES EN_VIDEOS EN_PROJECTS
    local migrated_count migrator var_name en_path old_path
    ...
    case $step_num in
        # ─────────────────────────────────────
        1) # UU 加速器安装 / UU Accelerator Install
        # ─────────────────────────────────────
            step_header 1
            ...
            echo ""
            if prompt_enter_or_quit "Press Enter to start installation"; then
        ...
        # ─────────────────────────────────────
        2) # XDG 用户目录转英文 / Migrate XDG Dirs to English
        # ─────────────────────────────────────
            step_header 2
            ...
            user_dirs_bak="$HOME/.config/user-dirs.dirs.bak.$(date +%s)"
            ...
            EN_DESKTOP="$HOME/Desktop"
            EN_DOWNLOAD="$HOME/Downloads"
            EN_TEMPLATES="$HOME/Templates"
            EN_PUBLIC="$HOME/Public"
            EN_DOCUMENTS="$HOME/Documents"
            EN_MUSIC="$HOME/Music"
            EN_PICTURES="$HOME/Pictures"
            EN_VIDEOS="$HOME/Videos"
            EN_PROJECTS="$HOME/Projects"
